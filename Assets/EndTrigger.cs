...
public class EndTrigger : MonoBehaviour
{
    ...
    IEnumerator LowerHand()
    {
        ...
        GameObject.FindGameObjectWithTag("Fawn").GetComponent<FawnMotion>().DecoupleSpeed = true;
        GameObject.FindGameObjectWithTag("Fawn").GetComponent<FawnMotion>().speedOverride = true;
        GameObject.FindGameObjectWithTag("Fawn").GetComponent<FawnMotion>().speed = 2.0f;
        yield return null;
    }
