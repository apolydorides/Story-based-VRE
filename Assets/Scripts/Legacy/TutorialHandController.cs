...
public class TutorialHandController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (timer > 0f && !TextController.Instance.voiceInstructions.isPlaying)
        {
        ...
        if (timer >= 8 && handModel.enabled == false && !TextController.Instance.voiceInstructions.isPlaying)
        {
